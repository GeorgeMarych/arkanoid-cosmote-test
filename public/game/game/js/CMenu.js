function CMenu() {
  ...
  this._init = function () {
    ...
    _pStartPosSave = {
      x: oSprite.width / 2 + 20,
      y: CANVAS_HEIGHT - oSprite.height / 2 - 20,
    };
    // _oButSave = new CGfxButton(
    //   _pStartPosSave.x,
    //   _pStartPosSave.y,
    //   oSprite,
    //   s_oStage
  ...
  this.refreshButtonPos = function () {
    ...
    // );
    // _oButSave.setPosition(
    //   _pStartPosSave.x + s_iOffsetX,
    //   _pStartPosSave.y - s_iOffsetY
    // );
  };
